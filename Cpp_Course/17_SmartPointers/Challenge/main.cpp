...
// Function prototypes
auto make(); //creating a ptr that menages a vector of ptr of shared objects
void fill(std::vector<std::shared_ptr<Test>> &vec, int num);
void display(const std::vector<std::shared_ptr<Test>>&vec);
//
//std::ostream &operator<<(std::ostream &os, const std::shared_ptr &obj) {
//	os << obj.get();
//	return os;
//}
auto make (){
...
//		std::cout << std::endl;
//		std::shared_ptr<Test> sh_ptr = std::make_shared<Test> (entered_value);
//		vec.push_back(sh_ptr);
		vec.push_back(std::make_shared<Test> (entered_value)); //moving semantics instead of copy semantics above
	} 
}
